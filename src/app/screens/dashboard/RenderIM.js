    ...
    await firebase
      ...
      .on("value", snap => {
        snap.forEach(child => {
          ...
          if (value) {
            if (
              (value.user1 === uid || value.user2 === uid) &&
              (value.user1 === neighborID || value.user2 === neighborID)
            ) {
              this.setState({
                msgId: child.key,
      ...
      <View style={[styles.dFlex, styles.modalContent]}>
        <View style={[styles.IMtopBoxContainer]}>
          <View style={[styles.dFlex, styles.topBox]}>
            <View style={[]}>
              <Image
                source={CoverImage}
                style={[styles.cover, styles.width(100), styles.height(100)]}
              />
            </View>
            <ScrollView
        ...
        <Content style={[styles.dFlex, styles.bottomBox]}>
          <View style={[styles.dFlex, styles.firstButtons]}>
            ...
            <Button
              style={[styles.btnBg("#fcbc30"), styles.sendIM]}
              onPress={() => {
